...
const defaultLines = [
  '갑구에 소유권 이전을 위한 가등기 설정됨.',
  '을구의 채권최고액과 보증금의 합이 시세의 80%를 초과함.',
  '특약: 임대인의 사정으로 계약 해지 시 위약금은 발생하지 않는다.',
  '전입 세입자의 임차권등기명령 기록이 존재함.',
  '부동산이 신탁등기 상태이므로, 신탁회사의 동의가 필요함.',
  '집주인의 세금 체납으로 인한 압류 기록이 있음.',
]
    ...
    >
      <div className='relative'>
        <span>
          ...
          <span className={`inline-block w-0.5 h-[1em] ml-px ${shouldShowCursor ? 'bg-blue-500 animate-pulse' : 'opacity-0'}`} />
        </span>
